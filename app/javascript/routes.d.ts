 ...
 * @returns {string} route path
 */
export const edit_user_job_path: ((
 ...
 * @returns {string} route path
 */
export const miniIndex_user_jobs_path: ((
  user_id: RequiredRouteParameter,
  options?: {format?: OptionalRouteParameter} & RouteOptions
) => string) & RouteHelperExtras;
 ...
 * @returns {string} route path
 */
export const new_user_job_path: ((
  user_id: RequiredRouteParameter,
  options?: {format?: OptionalRouteParameter} & RouteOptions
) => string) & RouteHelperExtras;
 ...
 * @returns {string} route path
 */
export const users_sign_out_path: ((
  options?: {format?: OptionalRouteParameter} & RouteOptions
) => string) & RouteHelperExtras;
